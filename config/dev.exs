...
config :sensor_array, SensorArrayWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "FdjyEWLE1LJV/mI8SVuyT79D0Vo5SBuZ5VmCQQ8e5dpPkwqRxIPWJcFDPrjbL6FH",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:sensor_array, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:sensor_array, ~w(--watch)]}
  ]
...
config :sensor_array, SensorArrayWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/sensor_array_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :sensor_array, dev_routes: true
